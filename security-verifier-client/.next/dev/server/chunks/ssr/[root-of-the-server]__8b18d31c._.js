...
"[project]/app/api/securityUsers.api.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getSecurityUsers = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/security-users");
    return response.data;
};
const createSecurityUser = async (data)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/security-users", data);
    return response.data;
};
const updateSecurityUser = async (id, data)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/security-users/${id}`, data);
    return response.data;
};
const deleteSecurityUser = async (id // ✅ FIXED HERE
)=>{
    await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/security-users/${id}`);
};
}),
...
"[project]/app/components/users/UsersTable.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$securityUsers$2e$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/securityUsers.api.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
function UsersTable({ users, onAddUser, onEditUser, onRefresh }) {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$securityUsers$2e$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteSecurityUser"])(id);
            await onRefresh();
        } catch (err) {
            alert('Delete failed');
        }
...
"[project]/app/components/users/UserForm.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserForm({ user, onClose, onSave, factories }) {
    /* ================= DERIVED INITIAL DATA ================= */ const initialData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>({
    ...
    /* ================= SYNC WHEN USER CHANGES ================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    /* ================= SUBMIT ================= */ const handleSubmit = async (e)=>{
        ...
        try {
            if (user) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$securityUsers$2e$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSecurityUser"])({
...
"[project]/app/user-crud/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$users$2f$UsersTable$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/users/UsersTable.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$users$2f$UserForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/users/UserForm.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function UserCrudPage() {
    ...
    const loadData = async ()=>{
        try {
            setLoading(true);
            const usersData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$securityUsers$2e$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSecurityUsers"])();
            setUsers(Array.isArray(usersData) ? usersData : []);
            const factoriesRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$factories$2e$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFactories"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$users$2f$UsersTable$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                users: users,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8b18d31c._.js.map